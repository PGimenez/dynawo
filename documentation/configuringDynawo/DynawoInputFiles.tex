...
\item mxiter (int)
\item fnormtol (double)
\item initialaddtol (double)
\item scsteptol (double)
\item mxnewtstep (double)
\item msbset (int)
\item printfl (int)
\end{itemize}

Here is the potential content of the par file containing the local initialization solver parameters :

\begin{lstlisting}[language=XML]
<set id="1">
  <par type="INT" name="mxiter" value="30"/>
  <par type="DOUBLE" name="fnormtol" value="0.0001"/>
  <par type="DOUBLE" name="initialaddtol" value="0.1"/>
  <par type="DOUBLE" name="scsteptol" value="0.0001"/>
...
<set id="2">
  ...
  <par type="DOUBLE" name="fnormtol" value="0.000001"/>
</set>
\end{lstlisting}
