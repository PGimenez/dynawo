...
model SpeedProtection "Sends a tripping signal to the generator when the frequency goes outside a safe region"
  ...
  import Dynawo.NonElectrical.Logs.TimelineKeys;
    ...
    parameter Types.VoltageModulePu omegaMinPu "Frequency threshold under which the automaton is activated in pu";
    parameter Types.VoltageModulePu omegaMaxPu "Frequency threshold above which the automaton is activated in pu";
    parameter Types.Time tLagAction "Time-lag due to the actual trip action in s";

    Modelica.Blocks.Interfaces.RealInput omegaMonitoredPu "Monitored voltage in pu (base UNom)" annotation(
