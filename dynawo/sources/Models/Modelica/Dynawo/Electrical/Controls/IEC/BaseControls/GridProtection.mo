...
model GridProtection "Grid protection system for wind turbines (IEC N°61400-27-1)"
  ...
  Modelica.Blocks.Interfaces.RealInput omegaFiltPu(start = SystemBase.omegaRef0Pu) "Filtered grid angular frequency frame in pu (base omegaNom)" annotation(
    Placement(visible = true, transformation(origin = {-180, -80}, extent = {{-20, -20}, {20, 20}}, rotation = 0), iconTransformation(origin = {-110, -40}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));

  //Output variable
  Modelica.Blocks.Interfaces.BooleanOutput fOCB(start = true) "Breaker position, true if closed" annotation(
