...
model CurrentLimiter "Current limitation module for wind turbines (IEC N°61400-27-1)"
  ...
  parameter Types.PerUnit IMaxPu "Maximum continuous current at converter terminal in pu (base UNom, SNom) (generator convention)"  annotation(
    Dialog(tab = "CurrentLimiter"));
  parameter Types.PerUnit IMaxDipPu "Maximum current during voltage dip at converter terminal in pu (base UNom, SNom) (generator convention)" annotation(
    Dialog(tab = "CurrentLimiter"));
  parameter Types.PerUnit Kpqu "Partial derivative of reactive current limit against voltage in pu (base UNom, SNom) (generator convention)" annotation(
    Dialog(tab = "CurrentLimiter"));
  parameter Boolean MdfsLim "Limitation of type 3 stator current (0: total current limitation, 1: stator current limitation)" annotation(
    Dialog(tab = "CurrentLimiter"));
  parameter Boolean Mqpri "Prioritisation of reactive power during FRT (0: active power priority, 1: reactive power priority)" annotation(
    Dialog(tab = "CurrentLimiter"));
  ...
  Modelica.Blocks.Interfaces.RealInput iMaxHookPu(start = 0) "Maximum hook continuous current at converter terminal in pu (base UNom, SNom) (generator convention)" annotation(
  ...
  Modelica.Blocks.Interfaces.RealInput omegaGenPu(start = SystemBase.omegaRef0Pu) "Converter angular frequency frame in pu (base omegaNom)" annotation(
...
equation
  connect(gain.y, iqMinPu) annotation(
    Line(points = {{221, 100}, {310, 100}}, color = {0, 0, 127}));
  connect(switch1.y, gain.u) annotation(
    Line(points = {{122, 100}, {198, 100}}, color = {0, 0, 127}));
  ...
  connect(feedback2.y, gain1.u) annotation(
    Line(points = {{49, -20}, {78, -20}}, color = {0, 0, 127}));
  ...
  connect(less.y, switch3.u2) annotation(
    Line(points = {{221, 0}, {258, 0}}, color = {255, 0, 255}));
  connect(iqMaxPu, switch3.y) annotation(
    Line(points = {{310, 0}, {281, 0}}, color = {0, 0, 127}));
  connect(min2.y, switch3.u1) annotation(
  ...
  connect(gain1.y, min2.u2) annotation(
    Line(points = {{102, -20}, {120, -20}, {120, -26}, {158, -26}}, color = {0, 0, 127}));
  connect(switch1.y, min2.u1) annotation(
    Line(points = {{122, 100}, {140, 100}, {140, -14}, {158, -14}}, color = {0, 0, 127}));
  connect(const4.y, feedback2.u1) annotation(
    Line(points = {{2, -20}, {32, -20}}, color = {0, 0, 127}));
  connect(UWTCFiltPu, feedback2.u2) annotation(
    Line(points = {{-320, -80}, {40, -80}, {40, -28}}, color = {0, 0, 127}));
  ...
  connect(const6.y, add.u2) annotation(
    Line(points = {{201, 60}, {220, 60}, {220, 80}, {234, 80}, {234, 62}}, color = {0, 0, 127}));
  connect(gain.y, add.u1) annotation(
    Line(points = {{222, 100}, {240, 100}, {240, 80}, {246, 80}, {246, 62}}, color = {0, 0, 127}));
