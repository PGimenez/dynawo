...
public
  ...
  parameter Real tFilter = 0.001 "First order delay in the impedance measurement in s";
...
equation
  if lineState.value == 2 or lineState.value == 3 then  // Can only read PMonitoredPu and QMonitoredPu if the line is connected on (at least) side1
  ...
  */
  ...
  elsewhen not (Z.re <= R1Pu and Z.im <= X1Pu and Z.re > -Z.im) and pre(tThresholdReached1) <> Constants.inf then
  ...
  elsewhen not (Z.re <= R2Pu and Z.im <= X2Pu and Z.re > -Z.im) and pre(tThresholdReached2) <> Constants.inf then
  ...
  elsewhen not (Z.re <= R3Pu and Z.im <= X3Pu and Z.re > -Z.im) and pre(tThresholdReached3) <> Constants.inf then
  ...
  elsewhen not (Z.re <= R4Pu and Z.im <= X4Pu and Z.re > -Z.im) and pre(tThresholdReached4) <> Constants.inf then
