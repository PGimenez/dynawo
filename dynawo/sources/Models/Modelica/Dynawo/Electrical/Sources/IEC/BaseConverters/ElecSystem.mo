...
model ElecSystem "Single line model (RLC filter) for electrical systems gamma module (IEC N°61400-27-1)"
...
*/
  ...
  //Input variable
  Modelica.Blocks.Interfaces.BooleanInput fOCB(start = true) "Breaker position, true if closed" annotation(
