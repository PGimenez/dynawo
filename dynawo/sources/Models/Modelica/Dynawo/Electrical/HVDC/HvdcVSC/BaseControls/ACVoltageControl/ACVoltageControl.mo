...
model ACVoltageControl "AC voltage control for HVDC"
  ...
  Modelica.Blocks.Interfaces.RealInput PPu(start = P0Pu) "Active power in pu (base SNom)" annotation(
    Placement(visible = true, transformation(origin = {-131, -70}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {-110, 100}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Modelica.Blocks.Interfaces.RealInput UPu(start = U0Pu) "Voltage module in pu (base UNom)" annotation(
    Placement(visible = true, transformation(origin = {-131, 30}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {-110, -20}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Modelica.Blocks.Interfaces.RealInput QPu(start = Q0Pu) "Reactive power in pu (base SNom)" annotation(
    Placement(visible = true, transformation(origin = {-131, -50}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {-110, -60}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Modelica.Blocks.Interfaces.RealInput URefPu(start = U0Pu + Lambda * Q0Pu) "Reference voltage in pu (base UNom)" annotation(
    Placement(visible = true, transformation(origin = {-131, -10}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {-110, 60}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  ...
  Modelica.Blocks.Interfaces.BooleanInput modeU(start = modeU0) "Boolean assessing the mode of the control: true if U mode, false if Q mode" annotation(
    Placement(visible = true, transformation(origin = {-131, 10}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {-110, -100}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Modelica.Blocks.Interfaces.BooleanInput blocked(start = false) "Boolean assessing the state of the HVDC link: true if blocked, false if not blocked" annotation(
    Placement(visible = true, transformation(origin = {-131, 70}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {0, 110}, extent = {{-10, -10}, {10, 10}}, rotation = -90)));
  Modelica.Blocks.Interfaces.RealInput IqMaxPu(start = sqrt(InPu ^ 2 - Ip0Pu ^ 2)) "Max reactive current reference in pu (base UNom, SNom)" annotation(
    Placement(visible = true, transformation(origin = {-131, 50}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {80, 110}, extent = {{10, -10}, {-10, 10}}, rotation = 90)));
  Modelica.Blocks.Interfaces.RealInput IqMinPu(start = - sqrt(InPu ^ 2 - Ip0Pu ^ 2)) "Min reactive current reference in pu (base UNom, SNom)" annotation(
    Placement(visible = true, transformation(origin = {-131, -90}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {40, 110}, extent = {{-10, -10}, {10, 10}}, rotation = -90)));
...
equation
  ...
  connect(URefPu, qRefQU.URefPu) annotation(
    Line(points = {{-131, -10}, {-116, -10}}, color = {0, 0, 127}));
  connect(QRefPu, qRefQU.QRefPu) annotation(
    Line(points = {{-131, -30}, {-119, -30}, {-119, -16}, {-116, -16}}, color = {0, 0, 127}));
  connect(UPu, iqMod.u[1]) annotation(
    Line(points = {{-131, 30}, {42, 30}}, color = {0, 0, 127}));
  ...
  connect(QPu, qRefQU.QPu) annotation(
    Line(points = {{-131, -50}, {-118, -50}, {-118, -20}, {-116, -20}}, color = {0, 0, 127}));
  connect(UPu, qRefQU.UPu) annotation(
    Line(points = {{-131, 30}, {-118, 30}, {-118, -6}, {-116, -6}}, color = {0, 0, 127}));
  connect(PPu, qRefLim.PPu) annotation(
    Line(points = {{-131, -70}, {-43, -70}, {-43, -21}, {-40, -21}}, color = {0, 0, 127}));
  connect(UPu, qRefLim.UPu) annotation(
    Line(points = {{-131, 30}, {-43, 30}, {-43, -5}, {-40, -5}}, color = {0, 0, 127}));
  connect(blocked, switch1.u2) annotation(
    Line(points = {{-131, 70}, {142, 70}, {142, 7}, {147, 7}}, color = {255, 0, 255}));
  ...
  connect(IqMinPu, variableLimiter.limit2) annotation(
    Line(points = {{-131, -90}, {115, -90}, {115, -9}, {119, -9}}, color = {0, 0, 127}));
  connect(IqMaxPu, variableLimiter.limit1) annotation(
    Line(points = {{-131, 50}, {115, 50}, {115, 7}, {119, 7}}, color = {0, 0, 127}));
  ...
  connect(UPu, max.u1) annotation(
    Line(points = {{-131, 30}, {-14, 30}, {-14, 20}, {-5, 20}}, color = {0, 0, 127}));
  ...
  connect(modeU, switch.u2) annotation(
    Line(points = {{-131, 10}, {-76, 10}, {-76, -13}, {-67, -13}}, color = {255, 0, 255}));
